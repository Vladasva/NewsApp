...
public final class QueryUtils {
    ...
    public static List<News> fetchNewsData(String requestUrl){
        ...
        //Extract relevant fields form the JSON response and create a lit of {@link News}
    ...
    private static List<News> extractFeatureFromJson(String newsJSON){
        ...
        try{
            ...
            for(int i = 0; i < newsArray.length(); i++){
                ...
                //Create a new {@link News} object with the title, time, url,
                //and url from JSON response.
                News news = new News(sectionName, title, time, url);
            ...
            //catch teh exception here, so the app doesn't crash. Print a log message
